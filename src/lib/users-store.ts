...
const INITIAL_USERS: AdminUser[] = [
  {
    ...
    email: "admin@alinashop.ec",
    username: "admin",
    passwordHash: bcrypt.hashSync("AlinaAdmin2026*", 10),
    role: "ADMIN",
    isActive: true,
  ...
  {
    id: "usr_colab_01",
    name: "Colaborador de Tienda",
    email: "colaborador@alinashop.ec",
    username: "colaborador",
    passwordHash: bcrypt.hashSync("Colaborador2026*", 10),
    role: "COLABORADOR",
    isActive: true,
