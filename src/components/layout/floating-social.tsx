  ...
  return (
    <>
      ...
      <aside
        ...
        className="fixed left-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-start gap-1.5 pointer-events-auto"
      >
        {/* Facebook */}
        <a
          ...
          className="group flex items-center bg-[#1877F2] hover:bg-[#166fe5] text-white rounded-r-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-x-1"
        >
          ...
          <span className="max-w-0 overflow-hidden whitespace-nowrap text-xs font-bold transition-all duration-300 ease-in-out group-hover:max-w-xs group-hover:pr-3.5">
            Facebook
          </span>
        </a>
        ...
        <a
          ...
          className="group flex items-center bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] hover:opacity-95 text-white rounded-r-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-x-1"
        >
          <div className="size-11 flex items-center justify-center shrink-0">
            <svg className="size-5 fill-current" viewBox="0 0 24 24">
        ...
        <a
          ...
          className="group flex items-center bg-black hover:bg-neutral-900 border-r border-t border-b border-neutral-800 text-white rounded-r-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-x-1"
        >
          <div className="size-11 flex items-center justify-center shrink-0">
            <svg className="size-5 fill-current" viewBox="0 0 24 24">
        ...
        <a
          ...
          className="group flex items-center bg-slate-900 hover:bg-slate-800 text-white rounded-r-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-x-1"
        >
          <div className="size-11 flex items-center justify-center shrink-0">
