    ...
    <aside aria-label="Canales de atención y redes sociales" className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-auto">
      ...
      >
        ...
        <a
          ...
          className="flex items-center gap-2.5 bg-[#1877F2] text-white px-3 py-2 rounded-full shadow-lg hover:bg-[#166fe5] transition-all hover:scale-105 group text-xs font-semibold"
          title="Síguenos en Facebook"
        >
          <span className="hidden sm:inline text-[11px] pl-1 font-medium">Facebook Alina Shop</span>
