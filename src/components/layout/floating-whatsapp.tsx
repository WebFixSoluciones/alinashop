...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2 group">
      {/* Tooltip Card */}
      {isOpen && (
        <div className="relative flex items-center gap-3 bg-white/95 backdrop-blur-md border border-slate-200/90 shadow-xl rounded-2xl p-3 pr-8 max-w-xs animate-in fade-in slide-in-from-bottom-2 duration-300">
          <button
            type="button"
            onClick={(e) => {
              e.stopPropagation();
          ...
          <div className="text-xs">
            ...
            <p className="text-slate-500 text-[11px] leading-tight">
              Escríbenos directo a WhatsApp para atención inmediata.
            </p>
          </div>
        </div>
      )}
