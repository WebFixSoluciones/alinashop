...
const STORAGE_KEY = "alina_lopdp_consent_v1";
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-slate-600 leading-relaxed">
                En <strong>Alina Shop</strong> tratamos tus datos conforme a la{" "}
                <span className="font-semibold text-slate-800">
                  Ley Orgánica de Protección de Datos Personales (LOPDP) de la República del Ecuador
                </span>
                . Utilizamos cookies técnicas esenciales y de análisis para garantizar la seguridad de tus compras, recordar tu carrito y mejorar tu experiencia.
              </p>
            </div>
          </div>
