        ...
        <div className="lg:col-span-5 xl:col-span-5 space-y-4 sm:space-y-6">
          ...
          <div className="border-b border-slate-100 pb-3 sm:pb-4">
            <div className="flex items-center gap-2">
              <span className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-alina-600">
                Línea Pastelería Alina Shop
              </span>
            </div>
            <h1 className="mt-1 font-display text-xl sm:text-2xl lg:text-3xl font-semibold text-slate-900 tracking-tight leading-tight">
              {product.name}
            </h1>
